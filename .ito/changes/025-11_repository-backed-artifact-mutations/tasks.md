...
- [x] 1.3 Validate the change proposal with `ito validate 025-11_repository-backed-artifact-mutations --strict`
...
- [x] 5.4 Run `make test` and `make check` and resolve all failures
