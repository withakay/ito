...
- \[x\] Verify bash completions work manually: `ito completion install bash && exec bash`
...
- \[x\] Verify fish completions work manually: `ito completion install fish`
...
- \[x\] Run `ito validate extend-shell-completions --strict` and resolve all issues
- \[x\] Update error messages to list all four supported shells
- \[x\] Verify `ito completion --help` documentation is current
