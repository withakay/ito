...
- **WHEN** user runs `ito next --change <id>`
...
- **WHEN** user runs `ito next --change <id> --json`
...
- **WHEN** user runs `ito instructions <artifact> --change <id>`
...
- **WHEN** user runs `ito instructions <artifact> --change <id> --json`
- **THEN** the system outputs JSON matching ArtifactInstructions interface

#### Scenario: Unknown artifact

- **WHEN** user runs `ito instructions unknown-artifact --change <id>`
