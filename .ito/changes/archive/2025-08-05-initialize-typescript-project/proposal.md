...
The Ito project needs a proper TypeScript foundation to build the minimal CLI that helps developers set up Ito file structures and keep AI instructions updated.
