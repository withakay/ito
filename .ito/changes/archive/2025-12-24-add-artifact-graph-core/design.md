...
This module will coexist with the current Ito system as a parallel capability, potentially enabling future migration or integration.
...
- Replacing existing Ito functionality
...
1. `${XDG_DATA_HOME:-~/.local/share}/ito/schemas/<name>.yaml` - Global user override
...
- Unix/macOS fallback: `~/.local/share/ito/`
- Windows fallback: `%LOCALAPPDATA%/ito/`
...
- Global user override: `${XDG_DATA_HOME:-~/.local/share}/ito/schemas/<name>.yaml`
