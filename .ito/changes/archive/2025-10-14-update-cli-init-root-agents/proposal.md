...
- Ensure `ito update` continues to reconcile both `ito/AGENTS.md` and the root stub, documenting the expected behaviour so mismatched setups self-heal.
