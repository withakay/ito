...
- \[x\] Change FILE_PATHS in `src/core/configurators/slash/cline.ts` from `.clinerules/ito-*.md` to `.clinerules/workflows/ito-*.md`
...
- \[x\] Verify the change follows Ito conventions
