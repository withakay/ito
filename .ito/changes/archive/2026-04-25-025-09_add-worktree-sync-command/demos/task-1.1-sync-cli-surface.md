# Task 1.1: Top-level sync CLI surface

*2026-04-24T05:55:49Z by Showboat 0.6.1*
<!-- showboat-id: 90f99a61-a1ab-404e-b622-c477616925d4 -->

Added the top-level ito sync command, the --force flag, dispatch wiring, and parser tests in a separate test module.

```bash
cargo test -p ito-cli parses_top_level_sync -- --nocapture
```
