...
The `ito list` command SHALL provide developers with a quick overview of all active changes in the project, showing their names and task completion status.

## Behavior

### Command Execution

WHEN `ito list` is executed
...
IF `ito/changes/` directory doesn't exist
...
This command provides that visibility with minimal effort, following Ito's philosophy of simplicity and clarity.
