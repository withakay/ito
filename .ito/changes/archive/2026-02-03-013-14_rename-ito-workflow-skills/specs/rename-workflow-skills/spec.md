...
### Requirement: ito-proposal renamed to ito-proposal

The skill formerly known as `ito-proposal` SHALL be renamed to `ito-proposal`.

#### Scenario: Skill directory name

- **WHEN** the skill is installed
- **THEN** it lives at `.opencode/skills/ito-proposal/` (or equivalent for other harnesses)

#### Scenario: Skill frontmatter name

- **WHEN** the skill SKILL.md is read
- **THEN** the `name` field is `ito-proposal`

### Requirement: ito-apply renamed to ito-apply

The skill formerly known as `ito-apply` SHALL be renamed to `ito-apply`.

#### Scenario: Skill directory name

- **WHEN** the skill is installed
- **THEN** it lives at `.opencode/skills/ito-apply/` (or equivalent for other harnesses)

#### Scenario: Skill frontmatter name

- **WHEN** the skill SKILL.md is read
- **THEN** the `name` field is `ito-apply`

### Requirement: ito-proposal has keyword-rich description

The `ito-proposal` skill SHALL have a description that triggers on planning/design language.
...
### Requirement: ito-apply has keyword-rich description

The `ito-apply` skill SHALL have a description that triggers on implementation language.
