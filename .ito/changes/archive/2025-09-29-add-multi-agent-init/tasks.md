...
- \[x\] 1.1 Detect existing Ito structures at the start of `ito init` and enter an extend mode instead of failing.
...
- \[x\] 4.1 Add tests covering rerunning `ito init` to add another tool and the scenario where the user declines to add anything.
