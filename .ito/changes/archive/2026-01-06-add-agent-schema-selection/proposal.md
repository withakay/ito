...
- Update `ito-new-change` skill to prompt user for schema selection
- Update `ito-continue-change` skill to work with any schema's artifacts
- Update `ito-apply-change` skill to handle schema-specific task structures
