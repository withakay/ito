...
Add support for Cline (VS Code extension) in Ito to enable developers to use Cline's AI-powered coding capabilities for spec-driven development workflows.
...
- New files: .clinerules/ito-\*.md, CLINE.md
