...
- \[x\] 2.1 Create src/core/templates/readme-template.ts with Ito README content
...
- \[x\] 4.3 Add validation for existing Ito directories with helpful error message
