...
1. **Implementing** - Code development phase with explicit steps:
...
1. **Archiving** - Post-deployment finalization phase
...
- **`ito list` prominence** - Essential for discovering changes and specs
...
- **Deprecation cleanup** - Remove noun-first patterns (ito change show)
...
- Use `ito list --specs` to discover current capabilities
