...
- Search existing work: `ito list --specs`, `ito list`
...
- Validate with `ito validate [change-id] --strict`
...
- **AND** summarize which assistant files were created versus refreshed (e.g., `CLAUDE.md (created)`, `.cursor/commands/ito-apply.md (refreshed)`)
