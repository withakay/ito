...
- \[x\] Delete `/ito/specs/cli-diff/spec.md`
...
- \[x\] Update ito/README.md to remove diff command from command list
- \[x\] Update CLAUDE.md template if it mentions diff command
- \[x\] Update any example workflows that use diff command

## 5. Update Related Files

- \[x\] Search and update any remaining references to "ito diff" in:
  - Template files
...
- \[x\] Document how to use `ito show` for viewing changes
