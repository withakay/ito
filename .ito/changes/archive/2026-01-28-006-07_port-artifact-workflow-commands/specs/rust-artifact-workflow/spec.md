# Spec Delta: rust-artifact-workflow

## Purpose

Port artifact workflow commands (create/status/instructions/templates) to Rust with identical behavior and filesystem writes.
