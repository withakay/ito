...
- **AND** SHALL instruct agents to create or use a dedicated change worktree before any write operation
- **AND** SHALL instruct agents not to make proposal artifacts, implementation changes, documentation edits, generated asset updates, or commits from the main/control checkout
