# Spec: embedded-openspec-schemas

## Purpose

Define the built-in OpenSpec schema set shipped by Ito, including attribution and validation expectations for those embedded third-party schemas.
