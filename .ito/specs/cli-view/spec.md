...
The `ito dashboard` command provides a comprehensive dashboard view of the Ito project state, displaying specifications, changes, and progress metrics in a unified, visually appealing format to help developers quickly understand project status.

`ito view` remains callable as a hidden deprecated alias.
