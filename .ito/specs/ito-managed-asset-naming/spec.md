...
Define canonical naming and ownership rules for Ito-managed assets so installers can distinguish generated lifecycle surfaces from user content safely.
