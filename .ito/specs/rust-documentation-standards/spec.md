# Rust Documentation Standards Specification

## Purpose

Define the documentation standards for Ito's Rust crates and public APIs so `cargo doc` output stays useful and warning-free.
