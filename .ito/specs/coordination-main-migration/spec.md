<!-- ITO:START -->
# Coordination Main Migration

## Purpose

This spec defines safe detection of legacy coordination storage, the read-write policy while it remains, and the reversible migration to tracked main-authoritative Ito state.
