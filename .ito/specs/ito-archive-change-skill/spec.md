# Ito Archive Change Skill Spec

## Purpose

Define the `/ito-archive-change` skill behavior for archiving completed changes.
...
- **AND** preserve `.ito.yaml` file in archived change
