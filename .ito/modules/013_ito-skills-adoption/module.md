...
## Purpose
Adopt and adapt the vendored `ito-skills/` (fork of Superpowers skills) into Ito, enabling consistent workflow instructions across OpenCode, Claude Code, and Codex. All workflow content flows through `ito agent instruction <artifact>` as the single source of truth.
...
- [ ] 013-07_integrate-brainstorming-with-ito
- [ ] 013-08_integrate-plan-execution-with-ito
- [ ] 013-09_fix-using-ito-skills-identity
