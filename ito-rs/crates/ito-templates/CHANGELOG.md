...
- *(ito)* Reset core workflow and release authority
...
- *(templates)* Compact prompt assets
...
- *(templates)* Clarify artifact mutation guidance
## [0.1.29] - 2026-04-26
...
- *(templates)* Enforce worktree write isolation ([#214](https://github.com/withakay/ito/pull/214))
...
- *(019-09)* Ito-update-repo skill, prefix rule, marker+version stamping
- *(023-09)* Marker-scoped harness manifest installs
- *(012-06)* Enforce change worktree guidance ([#210](https://github.com/withakay/ito/pull/210))
