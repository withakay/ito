...
- Removed the tmux-only tools configuration namespace and schema contract.

### Fixed

- Regenerated GitHub Copilot agent model defaults from the current Rust configuration instead of retaining stale schema values.
