...
<<<<<<< HEAD:ito-rs/crates/ito-core/src/workflow/mod.rs
=======
#[derive(Debug, thiserror::Error)]
/// Errors returned by template/schema helpers.
...
>>>>>>> aa43f54 (refactor: remove workflow command and migrate core workflow module to templates):ito-rs/crates/ito-core/src/templates/mod.rs
...
pub fn load_user_guidance(ito_path: &Path) -> Result<Option<String>, TemplatesError> {
>>>>>>> aa43f54 (refactor: remove workflow command and migrate core workflow module to templates):ito-rs/crates/ito-core/src/templates/mod.rs
...
=======
fn load_schema_yaml(schema_dir: &Path) -> Result<SchemaYaml, TemplatesError> {
>>>>>>> aa43f54 (refactor: remove workflow command and migrate core workflow module to templates):ito-rs/crates/ito-core/src/templates/mod.rs
