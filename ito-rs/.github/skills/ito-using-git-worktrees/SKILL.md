...
ls -d ../ito-worktrees 2>/dev/null   # Preferred (one level up)
...
0. ../ito-worktrees/ (preferred, one level up)
1. .worktrees/ (project-local, hidden)
2. ~/.config/ito/worktrees/<project-name>/ (global location)
...
Per Ito's rule "Fix broken things immediately":
...
### For Global Directory (~/.config/ito/worktrees)
...
case $LOCATION in
  .worktrees|worktrees)
    ...
    ;;
  ~/.config/ito/worktrees/*)
    path="~/.config/ito/worktrees/$project/$BRANCH_NAME"
    ;;
esac
