# Tasks for: 001-21_embed-and-export-workflow-schemas
...
```bash
ito tasks status 001-21_embed-and-export-workflow-schemas
ito tasks next 001-21_embed-and-export-workflow-schemas
ito tasks start 001-21_embed-and-export-workflow-schemas 1.1
ito tasks complete 001-21_embed-and-export-workflow-schemas 1.1
ito tasks show 001-21_embed-and-export-workflow-schemas
```
