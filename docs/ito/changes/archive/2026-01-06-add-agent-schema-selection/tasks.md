...
- \[x\] 1.2 Ensure `ito templates --schema <name>` returns artifact list for any schema
...
- \[x\] 2.3 Pass selected schema to `ito new change --schema <name>`
...
- \[x\] 3.2 Read artifact list dynamically from `ito status --json`
